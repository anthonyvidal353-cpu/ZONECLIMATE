...
- Pilotage **Modbus RTU (RS485)** des thermostats/gainable en direct (à la place de la télécommande filaire). Bornes confirmées : A-B-+-GND. L'utilisateur dispose du fichier protocole Modbus (à transmettre). Prévoir : dongle USB-RS485 sur l'automate + pilote Modbus backend (pymodbus/minimalmodbus) en parallèle du pilote Tuya. Testable uniquement sur matériel réel.
