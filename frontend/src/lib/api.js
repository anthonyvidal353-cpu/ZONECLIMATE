...
export const api = {
  ...
  getRegLogAccounts: () => http.get(`/admin/reg-logs/accounts`).then((r) => r.data),
  getRegLogs: (params = {}) => http.get(`/admin/reg-logs`, { params }).then((r) => r.data),
  getWifiStatus: () => http.get(`/system/wifi/status`).then((r) => r.data),
  scanWifi: () => http.get(`/system/wifi/scan`).then((r) => r.data),
  connectWifi: (ssid, password) => http.post(`/system/wifi/connect`, { ssid, password }).then((r) => r.data),
